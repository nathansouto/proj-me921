...
Todos os processos foram feitos utilizando a linguagem R de programação através do software RStudio junto com alguns pacotes de funções. Todos os códigos estão no repositório do Github \cite{meucodigo}.
...
\begin{enumerate}
  \item A variável "Rate" \  nas estatísticas de passe no ataque é uma medida que utiliza outras 5 medidas para seu cálculo (tentativas de passes, passes completos, jardas aéreas, touchdowns e interceptações). Nesse caso a "medida-resumo" \  Rate foi mantida e as outras foram retiradas. 
  \vspace{-3mm}
